    ...
    <div class="row">
      ...
      <form action="php_action/newUploads" method="post" enctype="multipart/form-data" class="col" id="uploadForm">
        ...
        <div class="card steps-form" style="display: flex;">
          ...
          <div class="card-body">
            <p class="h3 my-4">Select The Agency You wanna Upload Certificate For</p>
        ...
        <div class="card steps-form" style="display: none;">
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-8">
                <h3 class="mb-0 font-weight-normal"><span class="girl-name font-weight-bolder"> UPLOAD MEDICAL</span> </h3>
              </div>
