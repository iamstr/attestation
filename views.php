...
<?php include "includes/medical-sidebar.php"; ?>
            ...
            <table class="table align-items-center table-flush position-relative">
              ...
              <tbody class="list">
                ...
                <tr>
                 ...
                 <td  style="">
                                    <div class="dropdown ">
                                        <a class="btn btn-sm btn-icon-only text-light" href="javascript:void(0);" role="button" data-toggle="false" aria-haspopup="false" aria-expanded="false">
