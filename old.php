...
<?php include "includes/mol-sidebar.php"; ?>
            ...
            <table class="table align-items-center table-flush position-relative">
              <thead class="thead-light">
                <tr class="table-agent ">
                  ...
                  <th scope="col" class="sort position-sticky " style="top: 0px;" data-sort="CLIENT IDNUMBER" data-toggle-table="CLIENT IDNUMBER">DATE OF REQUEST</th> 
                  <th scope="col" class="sort position-sticky " style="top: 0px;" data-sort="CLIENT IDNUMBER" data-toggle-table="CLIENT IDNUMBER">FORM OF CONTRACT</th>
                  <th scope="col" class="sort position-sticky " style="top: 0px;" data-sort="CLIENT IDNUMBER" data-toggle-table="CLIENT IDNUMBER">FORM OF BOND</th>
                  <th scope="col" class="sort position-sticky " style="top: 0px;" data-sort="CLIENT PHONE" data-toggle-table="CLIENT PHONE">REQUEST INFO</th>

                </tr>
              </thead>
              <tbody class="list">
                <tr>
                  <td>EWAJIBU AGENCY</td>
                  <td>31-04-2022</td>
                   <th>
                    <div class="media align-items-center">
                      <a href="javascript:void(0);" class="avatar rounded-circle mr-3 light-src" role="button" data-target="#lightView" data-toggle="modal">
                  ...
                  <td class="budget">
                    <a href="javascript:void(0);" class="view-history steps-form-button-next" data-report="">Detailed Info</a>
                  </td>
                </tr>
<!--
                <tr>
...
-->
        ...
        <div class="card  steps-form">
          ...
          <div class="card-header border-0">
            <div class="row">
              <div class="col-12">
                <h4 class="mb-2"><a href="javascript:void(0)" role="button" class="steps-form-button-back"><i class="fas fa-chevron-left pr-2 " role="button"></i><span>Go back</span></a></h4>
              </div>
            </div>
            <div class="row align-items-center justify-content-between">
              <div class="col-8">
                <h3 class="mb-0 girl_name">Ewajibu Agency</h3>
              </div>
              <div class="col-4 ">
                <h3 class="mb-0 font-weight-bolder text-right d-flex justify-content-center align-content-end"> <small class="pr-1 py-0">  </small> <strong class="girl_total"></strong> </h3>
              </div>
            </div>
          </div>
          <!-- Light table -->
          <div class="table-responsive slideLeft">
            <table class="table align-items-center table-flush position-relative">
              <thead class="thead-light">
                <tr class="table-agent ">
                  <th>SURNAME</th>
              ...
              <tbody class="list">
                ...
                <tr>
                 ...
                 <td class="text-center" style="">
                                  <span class="badge badge-primary">TRAVELLELD</span>
                                </td>
                </tr>
  ...
  <div class="light-view modal fade" aria-modal="true" tabindex="-1" aria-labelledby="exampleModalLabel" role="dialog" id="lightView">
        <div class="light-view-display modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Close Display </h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span>
              </button>
            </div>
            <img src="assets/img/edaji/ms-icon-310x310.png" alt="" class="light-view-display-image bounce">
          </div>
